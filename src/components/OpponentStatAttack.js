...
/**
 * Creates a clickable field for the Opponent's Stats for attack.
 ...
 */
function OpponentStatAttack({ initialText, initialColor, size, initialTextColor }) {
...
export default OpponentStatAttack;