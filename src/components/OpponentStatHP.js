...
/**
 * Creates a clickable field for the Opponent's Stats for HP.
 ...
 */
function OpponentStatHP({ initialText, initialColor, size, initialTextColor }) {
