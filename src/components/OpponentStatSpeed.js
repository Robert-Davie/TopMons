...
/**
 * Creates a clickable field for the Opponent's Stats for Speed.
 ...
 */
function OpponentStatSpeed({ initialText, initialColor, size, initialTextColor }) {
...
export default OpponentStatSpeed;
